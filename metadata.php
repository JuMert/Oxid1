...
$aModule = [
    ...
    'extend' => [
        ...
        \OxidEsales\Eshop\Application\Controller\ForgotPasswordController::class => \RESPONSEGmbH\resGoogleCaptcha\Application\Controller\resGoogleCaptcha_ForgotPasswordController::class,
    ...
    'blocks' => [
        ...
        ['template' => 'form/forgotpwd_email.tpl', 'block' => 'captcha_form', 'file' => '/Application/views/blocks/resGoogleCaptcha_pwforgot_captcha_form.tpl', 'position' => 100],
    ],
    'settings' => [
        #Main
        [
        ...
        [
            'group' => 'resgooglecaptcha_err_msg',
            'name' => 'sResGoogleCaptcha_err_sv',
            'type' => 'str',
            'value' => 'Vänligen lös robotfiltret!',
        ],
        #Show On
        [
        ...
        [
            'group' => 'resgooglecaptcha_showOn',
            'name' => 'blResGoogleCaptcha_show_pwforgot',
            'type' => 'bool',
            'value' => 'false',
        ],
    ],
